...
To add a worker to this swarm, run the following command:
    ...
    docker swarm join 192.168.0.18:2377 \
        --token SWMTKN-1-4ge7nq62fbutfpsfevik6g6mrvbykcqj8ymdbmmj5lwuzli5no-7c14ew5u8m4jss5q71ifnk3c9
```
...
To add a manager to this swarm, run the following command:
    ...
    docker swarm join 192.168.0.18:2377 \
        --token SWMTKN-1-4ge7nq62fbutfpsfevik6g6mrvbykcqj8ymdbmmj5lwuzli5no-9w44s6uatxkl7c9rl17hwaqkj
```
