...
Besides these interesting locations in the filesystem of the host, there are other resources that have been created with a fresh installation of Docker.
